...
class AppDelegate: NSObject, NSApplicationDelegate {
    ...
    let configs = ["mechanical-keyboard", "pentatonic", "easter-eggs", "midi", "git", "voice", "command-line"]
    let titles = ["Mechanical Keyboard", "Pentatonic","Easter Eggs", "MIDI", "Git Keywords", "Voice Over", "Bash Keywords"]
